...
var EntityHeadUnstyled = function (_a) {
    var classes = _a.classes, title = _a.title, filters = _a.filters, canCreate = _a.canCreate, url = _a.url, setFilters = _a.setFilters, applyFilter = _a.applyFilter;
    var setFilterCurrent = useCallback(function (current) {
        setFilters(__assign(__assign({}, filters), { current: current }));
    }, [setFilters, filters]);
    ...
    return (React.createElement(Grid, { container: true, justify: "space-between", alignItems: "flex-end", className: classes.header },
        ...
        filters && (React.createElement(Filter, { current: filters.current, value: filters.value, fields: filters.fields, clearFilter: clearFilter, setFilterCurrent: setFilterCurrent, setFilterValue: setFilterValue, applyFilter: applyFilter })),
