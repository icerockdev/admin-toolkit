...
var EntityHeadUnstyled = function (_a) {
    var classes = _a.classes, title = _a.title, buttons = _a.buttons, filters = _a.filters, fields = _a.fields, canCreate = _a.canCreate, url = _a.url, filterData = _a.filterData, setFilters = _a.setFilters, applyFilter = _a.applyFilter;
    ...
    return (React.createElement(Grid, { container: true, justify: "space-between", alignItems: "center", className: classes.header },
        title,
        filters && (React.createElement(Filter, { filterData: filterData, fields: fields, filters: filters, setFilters: setFilters, applyFilter: applyFilter, clearFilter: clearFilter })),
