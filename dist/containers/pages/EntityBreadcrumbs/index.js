...
var EntityBreadcrumbs = withStyles(styles)(observer(function (_a) {
    var name = _a.name, url = _a.url, isEditing = _a.isEditing, isCreating = _a.isCreating, classes = _a.classes, id = _a.id, fields = _a.fields, data = _a.data, buttons = _a.buttons;
