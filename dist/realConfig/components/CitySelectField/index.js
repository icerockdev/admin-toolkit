...
var CitySelectField = observer(function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, withToken(function (_a) {
                            var token = _a.token;
                            return Axios.get(options.getRegionsUrl + "/" + data.regionId + "/cities", {
    ...
    var onCityChange = useCallback(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return isEditing ? (React.createElement(FormControl, { variant: "outlined" },
        ...
        React.createElement(Select, { variant: "outlined", id: label, name: label, label: label, value: value || '', onChange: onCityChange, error: !!error, inputProps: { className: 'select' } },
            React.createElement(MenuItem, { value: "" }, "..."),
            cities.length > 0 &&
                cities.map(function (city) { return (React.createElement(MenuItem, { key: city.value, value: city.value }, city.label)); })))) : (React.createElement("div", null, ((_b = data === null || data === void 0 ? void 0 : data.city) === null || _b === void 0 ? void 0 : _b.name) || ''));
});
