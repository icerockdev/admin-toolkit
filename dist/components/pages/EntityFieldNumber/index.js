...
var EntityFieldNumber = function (_a) {
    ...
    return isEditing ? (React.createElement("div", null,
        React.createElement(TextField, { type: "number", label: label, value: value || '', onChange: onChange, error: !!error, helperText: error, variant: "outlined" }))) : (React.createElement("div", { onClick: onClick }, val || React.createElement("div", null, "\u00A0")));
};
