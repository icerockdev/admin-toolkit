...
var EMPTY_TOKENS = {
    access: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJBdXRoZW50aWNhdGlvbiIsImF1ZCI6ImFsbGlhbmNlLWF1ZGllbmNlIiwicm9sZSI6MTAsImlzcyI6Imh0dHA6Ly8wLjAuMC4wOjgwIiwiaWQiOjEsInVzZXJUeXBlIjoxMCwidHlwZSI6IkFDQ0VTUyIsImV4cCI6MTU4NTU4OTc5OCwiaWF0IjoxNTg1NTUzNzk4fQ.BTcx11KuscqDU2XRHJ9aD8od7gtsgpIEOffJxtWQV52yCAn_UCgQ9WaPQFE36_hAar6yTifQCgjtuKWidUeh1A',
    refresh: '',
};
var JWTAuthProvider = /** @class */ (function (_super) {
    ...
    function JWTAuthProvider(fields) {
        ...
        _this.sendAuthRequest = function (_a) {
        ...
        _this.withToken = function (req, args) {
            return req(__assign(__assign({}, args), { token: "Bearer " + _this.tokens.access }));
        };
        return _this;
    }
