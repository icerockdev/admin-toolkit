...
var Entity = /** @class */ (function (_super) {
        ...
        get: function () {
            ...
            return (this.editable &&
                !!(!this.roles ||
                    ...
                    (((_c = (_b = (_a = this.parent) === null || _a === void 0 ? void 0 : _a.auth) === null || _b === void 0 ? void 0 : _b.user) === null || _c === void 0 ? void 0 : _c.role) && ((_e = (_d = this.permissions) === null || _d === void 0 ? void 0 : _d.update) === null || _e === void 0 ? void 0 : _e.includes((_g = (_f = this.parent.auth) === null || _f === void 0 ? void 0 : _f.user) === null || _g === void 0 ? void 0 : _g.role)))));
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(Entity.prototype, "Breadcrumbs", {
        get: function () {
            ...
            return observer(function (_a) {
                ...
                return (React.createElement(EntityBreadcrumbs, { data: _this.editorData, fields: _this.fields, id: id, name: _this.title, url: _this.menu.url, isEditing: isEditing, isCreating: isCreating, buttons: buttons, viewable: _this.viewable, editable: _this.canEdit }));
            });
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(Entity.prototype, "output", {
        get: function () {
            var _this = this;
            return observer(function () { return (React.createElement(Provider, { entity: _this },
