...
var EntityFieldString = function (_a) {
    ...
    return isEditing ? (React.createElement("div", null,
        React.createElement(TextField, { label: label, value: value || '', onChange: onChange, error: !!error, helperText: error, variant: "outlined" }))) : (React.createElement("div", { onClick: onClick, dangerouslySetInnerHTML: { __html: text ? String(text) : '&nbsp;' } }));
};
